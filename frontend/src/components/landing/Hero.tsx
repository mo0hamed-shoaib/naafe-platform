...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative text-white text-center py-20 md:py-48 px-4 font-arabic overflow-hidden">
      ...
      />
      {/* Mobile blur overlay */}
      <div className="absolute inset-0 md:hidden" style={{backdropFilter: 'blur(2px)'}} aria-hidden="true"></div>
      ...
      {/* Scroll indicator */}
      <div className="absolute left-1/2 bottom-6 -translate-x-1/2 z-20 flex flex-col items-center animate-bounce">
