    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">ما يقوله الناس</h2>
          <p className="text-lg text-gray-600 mt-2">قصص من مجتمعنا.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="card bg-naafe-cream shadow-xl">
              <div className="card-body">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex text-naafe-orange">
                      {[...Array(5)].map((_, i) => (
