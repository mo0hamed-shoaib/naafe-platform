    ...
    <section className="py-16 sm:py-24 bg-white" id="how-it-works">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">كيف يعمل</h2>
          <p className="text-lg text-gray-600 mt-2">خطوات بسيطة لإنجاز الأمور.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="card bg-naafe-cream shadow-xl hover:scale-105 transition-transform">
              <div className="card-body items-center text-center">
                <div className="p-4 bg-naafe-teal text-white rounded-full mb-4">{step.icon}</div>
                <h3 className="card-title text-xl font-bold text-gray-800">{step.title}</h3>
